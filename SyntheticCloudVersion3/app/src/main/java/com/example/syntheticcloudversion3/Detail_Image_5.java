 ...
 */
public class Detail_Image_5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sharedPreferences = Detail_Image_5.this.getSharedPreferences(getString(R.string.PREF_FILE),
                MODE_PRIVATE);
        ...
        textView.setText("Aeolus Lite - Gold \n" +
                "$42.00\n" +
