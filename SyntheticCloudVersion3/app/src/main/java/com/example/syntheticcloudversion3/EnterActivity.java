...
//        listView = (ListView) findViewById(R.id.list_view);
        ...
        i = product_labels.length;
//        Toast.makeText(getApplicationContext(),Integer.toString(i),Toast.LENGTH_SHORT).show(); //debug
        new MyTask().execute();
    }
        ...
        class MyTask extends AsyncTask<String,String,String>
        {
            ...
            protected String doInBackground(String... voids) {
                for(String Name: product_labels)
                {
                ...
                return "All the Products were added Successfully";
            }


            protected void onProgressUpdate(String... values) {
                dataProvider = new ProductDataProvider( product_poster_resource[something],
                        values[0],product_costs[something]);
