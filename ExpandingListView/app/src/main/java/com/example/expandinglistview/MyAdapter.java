package com.example.expandinglistview;
...
public class MyAdapter extends BaseExpandableListAdapter {
    ...
    public int getGroupCount() {
        return header_titles.size(); //return the size of the list.
    }

    @Override
    public int getChildrenCount(int i) {
        return child_titles.get(header_titles.get(i)).size(); //return the size of each header.
    }
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view == null)//check if the row exist
        {
    ...
    public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
        ...
        if(view == null)//checks if the item is inflated or not.
        {
            LayoutInflater layoutInflater = (LayoutInflater)this.ctx.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
